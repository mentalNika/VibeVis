          ...
          <Group gap={60} justify="center">
            ...
            <Box maw={500}>
              ...
              <Text>
                ...
                пространств, которые помогают дизайнерам и архитекторам выгодно
                презентовать свои проекты.
                <br />
                <br />
                Особое внимание уделяю атмосфере и реалистичности изображения, а
                также ценю комфортное и честное сотрудничество. Постоянно
